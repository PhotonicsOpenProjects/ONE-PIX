...
class OPApp(ctk.CTk):
    def __init__(self):
        ...
        self.calibrationButton = ctk.CTkButton(
            self.Mode_frame,
            text=self.widgets_text["specific_GUI"]["Addressed"]["Advanced"][
                "calibrationButton"
            ],
            fg_color="#D70000",
            hover_color="#9D0000",
        ...
        self.integration_time_label = ctk.CTkLabel(
            self.Mode_frame,
            text=self.widgets_text["specific_GUI"]["Addressed"]["Advanced"][
    ...
    def plotMask(self):
        ...
        #Normalisation only activated when asked by user from the HUB.py GUI

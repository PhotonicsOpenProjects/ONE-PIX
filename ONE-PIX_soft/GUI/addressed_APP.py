...
# =============================================================================
        ...
        self.calibrationButton = ctk.CTkButton(self.Mode_frame, text = self.widgets_text["specific_GUI"]["Addressed"]["calibrationButton"],
        ...
        self.KMeans_desc = ctk.CTkLabel(self.Mode_frame, text = self.widgets_text["specific_GUI"]["Addressed"]["KMeans_desc"], font=('Helvetica', 18, 'bold'))
        self.KMeans_desc.grid(column=0, row=1, padx=(2.5,2.5), pady=(2.5,2.5), rowspan=1, columnspan=1, sticky='we')
        

        
        self.manual_choice = ctk.CTkButton(self.Mode_frame, text = self.widgets_text["specific_GUI"]["Addressed"]["manual_choice"], fg_color="gray",
        ...
        self.auto_choice = ctk.CTkButton(self.Mode_frame, text=self.widgets_text["specific_GUI"]["Addressed"]["auto_choice"], state = "disabled",
...
# =============================================================================
        ...
        self.KMeans_desc = ctk.CTkLabel(self.Params_frame, text = self.widgets_text["specific_GUI"]["Addressed"]["KMeans_desc"], font=('Helvetica', 18, 'bold'))
        self.KMeans_desc.grid(column=0, row=0, padx=(2.5,2.5), pady=(2.5,2.5), rowspan=1, columnspan=1, sticky='w')
        
        self.Prim_seg_label = ctk.CTkLabel(self.Params_frame,text = self.widgets_text["specific_GUI"]["Addressed"]["Prim_seg_label"])
        ...
        self.Sec_seg_label = ctk.CTkLabel(self.Params_frame,text = self.widgets_text["specific_GUI"]["Addressed"]["Sec_seg_label"])
...
# =============================================================================
        ...
        self.acquireButton = ctk.CTkButton(self.Acquis_frame, text = self.widgets_text["specific_GUI"]["Addressed"]["acquireButton"],
...
# =============================================================================
        ...
        self.loadButton = ctk.CTkButton(self.Open_frame, text = self.widgets_text["specific_GUI"]["Addressed"]["loadButton"],
    ...
    def do_calibration(self):
        ...
        self.calibrationButton.configure(fg_color="#31D900", hover_color="#249F00",
                                         text=self.widgets_text["specific_GUI"]["Addressed"]["calibrationButton"])
    ...
    def acquire(self):
        ...
        self.acquireButton.configure(state = 'normal', fg_color = "#3B8ED0",
                                     text=self.widgets_text["specific_GUI"]["Addressed"]["acquireButton"])
    ...
    def plotMask(self, path):
        ...
        self.a_vis.set_xlabel(self.widgets_text["specific_GUI"]["Addressed"]["functions"]["plotMask"]["xlabel"], fontsize = 10)
